...
def import2mongo(item, database_name: str, collection_name: str, host: str, port: int):
...
def export2mongo(item, database_name: str, collection_name: str, host: str, port: int):
    mc = MongoClient(host=host, port=port)
    db = mc[database_name]
    collection = db[collection_name]
